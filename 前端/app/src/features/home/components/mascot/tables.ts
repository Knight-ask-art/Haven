...
Object.assign(SPRINGS, {
  spin: [2.2, 0.95], x: [1.6, 0.96], y: [1.8, 0.96],
  squash: [3.5, 0.92], blink: [10.0, 0.95], eyeScale: [3.8, 0.92],
  gazeX: [3.0, 0.98], gazeY: [3.0, 0.98], shape: [3.0, 0.95],
});

export const GROK_TABLES = {
