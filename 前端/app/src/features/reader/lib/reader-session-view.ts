...
/** Only a validated ready session may provide content to the reader. */
export function selectReaderSessionView(state: MediaSessionState, mediaItemId: string | undefined): ReaderSessionView {
  switch (state.status) {
    case "ready":
